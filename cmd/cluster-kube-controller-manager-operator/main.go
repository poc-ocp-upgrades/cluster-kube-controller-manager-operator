...
func NewSSCSCommand() *cobra.Command {
	...
	_logClusterCodePath()
	defer _logClusterCodePath()
	cmd := &cobra.Command{Use: "cluster-kube-controller-manager-operator", Short: "OpenShift cluster kube-controller-manager operator", Run: func(cmd *cobra.Command, args []string) {
		cmd.Help()
		os.Exit(1)
	}}
